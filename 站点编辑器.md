...
临时阅读模式
---
> 含义：将高亮部分生成 `阅读模式`，适合未适配阅读模式的页面，详细操作，[请看这里](http://ksria.com/simpread/welcome/version_1.0.4.html#temp-read-mode)
...
> 因为是高亮选择，所以某些生成的页面并不完美，所以如果要呈现完美的页面效果，还是以手动适配页面为主导，作为一种【在未适配页面使用阅读模式】的补充。
